...
const hispostid = new MMKVStorage.Loader()
...
export const _addHistory = async ({
  id = '',
  title = '',
  last_title = '',
  last_id = '',
  image = '',
}: historyPost): Promise<boolean> => {
  try {
...
export const _updateHistoryId = async (
  id: string,
  last_id: string,
  last_title: string,
): Promise<boolean> => {
